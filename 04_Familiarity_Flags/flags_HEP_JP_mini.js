...
=======
    ...
    'img/zw.png',
    'img/un.png'
>>>>>>> 9360ee454ee5e2ae288e8993d01c0aacb0f50332
  ]
};
...
=======
    <p>まず、これから勉強セッションが始まります。</p>
    <p>国旗と国名が一緒に表示されるので、国旗と国名を覚えてください。</p>
    <p>次の項目に進むには、「NEXT」をクリックしてください。</p>
    <p>※注視点が表示されている間だけ、まばたきができます※</p>
    </div>
    <p>それでは「START」をクリックして、勉強セッションを始めてください。</p>
>>>>>>> 9360ee454ee5e2ae288e8993d01c0aacb0f50332
...
=======
    <p>少し休憩してください。</p>
    <p>次の試行に進む準備ができたら、「CONTINUE」をクリックしてください。</p>
    <p>実験が再開できるまで：  <span id="clock">1:00</span>
    </div>
    `,
  choices: ['CONTINUE'],
  on_load: function () {
