...
//1. First part, show the items once

var show_instructions = {
    type: jsPsychHtmlButtonResponse,
    stimulus: `
    <div style="font-size:24px;">
    <p>In this part of the experiment, you will be shown set of flags corresponding to UN member countries followed by their names.</p>
    <p>Each flag will reappear 1 time, so you are able to associate the flag to the right country.</p>
...
main_timeline.push(show_instructions);
...
var fixation = {
    ...
    trial_duration: function(){
       return jsPsych.randomization.sampleWithoutReplacement([50, 75, 100, 125, 150, 175, 200], 1)[0];       
      }, 
    data: {
	    task: 'fixation'
	  }
...
//2. Second part: Show the items randomly three times  

var learn_instructions = {
    type: jsPsychHtmlButtonResponse,
    stimulus: `
    <div style="font-size:24px;">
    <p>In this part of the experiment, each flag will reappear 3 times randomly, so you are able to associate the flag to the right country.</p>
    <p>Tap "START" to begin.</p>
    </div>
    `,
    choices: ['START'],
...
var repeated_variables = jsPsych.randomization.repeat(variables,3);

var flashcard_study_rdm = {
    timeline: [trial_pic,trial_name,fixation],
    timeline_variables: repeated_variables  
 };
 main_timeline.push(flashcard_study_rdm,rest);
